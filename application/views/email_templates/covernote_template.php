															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	...
																	<td valign="top" class="imageContent">
																		<img src="<?php echo base_url().$message_header; ?>" width="500" class="flexibleImage" style="max-width:500px;width:100%;display:block;" alt="Text" title="Text" />
																	</td>
													...
													<tr>
														<td align="center" valign="top" width="500" class="flexibleContainerCell">
															...
															<table border="0" cellpadding="0" cellspacing="0" width="100%">
																<tr>
																	<td valign="top" class="imageContent">
																		<img src="<?php echo base_url().$message_footer; ?>" width="500" class="flexibleImage" style="max-width:500px;width:100%;display:block;" alt="Text" title="Text" />
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
